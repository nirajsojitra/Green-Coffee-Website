...
<head>
    ...
    <title>green coffe admin panel - active products page</title>
</head>
<body>
        ...
        <div class="box-container">
...

            {
             ...
             <form action="" method="post" class="box">
                ...
                <div class ="flex-btn">
                    <a href="edit_product.php? id=<?=$fetch_products['product_id']; ?>"class="btn">edit</a>
                    <button type="submit" name ="delete" class="btn" onclick="return confirm('delete this product');">delete</button>

                    <a href="read_product.php? post_id=<?=$fetch_products['product_id']; ?>"class="btn">view </a>
                </div>
